      ...
      <div class="row">
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"> <img src="{{url('img/logo.png')}}" alt="logo"> </a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-lg-4">
          <div class="single_appartment_part">
            <div class="appartment_img">
              <img src="{{url('front/img/appertment_1.png')}}" alt="">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="single_appartment_part">
            <div class="appartment_img">
              <img src="{{url('front/img/appertment_2.png')}}" alt="">
              <div class="single_appartment_text">
                <h3>$1,235632</h3>
                <p><span class="ti-location-pin"></span> 384 Treeline Park, San Antonio, TX</p>
              </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-lg-6">
          <div class="room_1">
            <img src="{{url('front/img/room_1.png')}}" alt="">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="room_2">
            <img src="{{url('front/img/room_2.png')}}" alt="">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-7">
          <div class="single_blog">
            <div class="appartment_img">
              <img src="{{url('front/img/blog_1.png')}}" alt="">
            </div>
            <div class="single_appartment_content">
        ...
        <div class="col-md-6 col-lg-5">
          <div class="right_single_blog">
            <div class="single_blog">
              <div class="media">
                <img src="{{url('front/img/blog_2.png')}}" class=" mr-3" alt="...">
            ...
            <div class="single_blog">
              <div class="media">
                <img src="{{url('front/img/blog_3.png')}}" class="mr-3" alt="...">
                <div class="media-body align-self-center">
            ...
            <div class="single_blog">
              <div class="media">
                <img src="{{url('front/img/blog_4.png')}}" class="mr-3" alt="...">
                <div class="media-body align-self-center">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3">
          <div class="single_footer_part">
            ...
            <a href="index.html" class="footer_logo"> <img src="{{url('front/img/footer_logo.png')}}" alt="#"> </a>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="single_footer_part">
