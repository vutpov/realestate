...
@section('content')
    <section style="margin-top:80px; background-color: #FAFAFA;" class="text-center">
        <div class="container">
            ...
            <div class="row">
                <h5 style="color:#6F6F6F; letter-spacing:1px; word-spacing:4px;" class="">
                    Thank you for your interest in our service. Please contact us using the information below. To get the latest updates from Our Company, connect with us on social media.
                </h5>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="container">
                        <div class="pl-3 pt-5">
                            <i style="font-size:10em;" class="fas fa-envelope-open-text"></i>
                ...
                <div class="col-lg-4">
                    <div class="pt-5">
                        <div class="container">
                            <i style="font-size:10em;" class="far fa-compass"></i>
                ...
                <div class="col-lg-4">
                    <div class="pt-5">
                        <div class="container">
                            <i style="font-size:10em;" class="fas fa-phone-volume"></i>
        ...
        <iframe style="padding-top:50px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1604.0470679484329!2d104.89415749587096!3d11.568023473056328!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31095173761d4a53%3A0xcd09ff2f4d326e3f!2sSETEC+Institute!5e0!3m2!1sen!2skh!4v1563075108615!5m2!1sen!2skh" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
